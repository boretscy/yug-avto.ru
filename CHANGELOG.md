...
- Исправлена работа фильтра на главной странице (`main.filter`):
  - Устранено двойное срабатывание обработчиков клика на выпадающих списках (`stopImmediatePropagation`), из-за которого кратковременно сбрасывался выбранный бренд и обнулялся счетчик авто.
  - Обеспечено корректное динамическое обновление списка моделей при выборе марок (исправлено определение флага `update.models`).
  - Синхронизировано состояние формы и отправка актуальных параметров `brands` и `models` при клике на элементы выпадающих списков.
  - Исправлено обновление ценового диапазона, количества авто и счетчиков в селектах при выборе моделей.
