...
$(document).on('click', '.form-dropcontainer .form-droplist-item', function(e) {
    if ($(this).closest('form[data-sid="MAIN_FILTER"]').length || $(this).closest('#YappsShowroom').length || $(this).closest('.form-droplist').attr('data-link')) {
        return;
    }
