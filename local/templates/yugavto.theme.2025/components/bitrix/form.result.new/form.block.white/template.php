...
<div class="container my-5 form-block-white" data-form="<?= $arResult['arForm']['SID'];?>">
	<div class="row">
		<div class="col">
			<div class="bg-yawhite b-radius-yaradius-16 p-4">
				<div class="row">
					<div class="col-lg-7 position-lg-relative ">
						<img class="form-blobk-white-image position-xl-absolute" src="<?= CFile::GetPath($arResult['SETTINGS']['PROPERTY_IMAGE_VALUE']);?>" />
						<img class="form-blobk-white-title-image position-xl-absolute" src="<?= CFile::GetPath($arResult['SETTINGS']['PROPERTY_TITLE_IMAGE_VALUE']);?>" />
					</div>
					<div class="col-lg-5">
						<div class="b-radius-yaradius25 bg-yawhite p-2 py-lg-4 px-lg-4 h-100 d-flex justify-content-center card-v-flex">
							...
							<div class="row mb-3 d-none w-100" role="success">
								<div class="col d-flex flex-column justify-content-center align-items-center">
									<div class="p-3 bg-yawhite c-yablack text-center">
							...
							<div class="row mb-3 mt-5 d-none w-100" role="error">
								<div class="col d-flex flex-column justify-content-center align-items-center">
									<div class="p-3 bg-yalightgray c-yablack text-center">
