...
<div class="container my-5 form-line-white" data-form="<?= $arResult['arForm']['SID'];?>">
	<div class="row">
		<div class="col">
			<div class="bg-yawhite b-radius-yaradius-16 p-4">
				<div class="row">
					<div class="col-lg-<?= (($arResult['SETTINGS']['PROPERTY_IMAGE_VALUE'])?'6':'5');?> position-relative">
						<img class="form-line-white-title-image" src="<?= CFile::GetPath($arResult['SETTINGS']['PROPERTY_TITLE_IMAGE_VALUE']);?>" />
						<?php if ( $arResult['SETTINGS']['PROPERTY_IMAGE_VALUE'] ) { ?>
						<img class="form-line-white-image position-absolute d-none d-lg-block" src="<?= CFile::GetPath($arResult['SETTINGS']['PROPERTY_IMAGE_VALUE']);?>" />
						<?php } ?>
					</div>
					<div class="col-lg-<?= (($arResult['SETTINGS']['PROPERTY_IMAGE_VALUE'])?'6':'7');?>">
						<div class="b-radius-yaradius25 bg-yawhite p-2 py-lg-5 px-lg-4 h-100 d-flex justify-content-center card-v-flex">
