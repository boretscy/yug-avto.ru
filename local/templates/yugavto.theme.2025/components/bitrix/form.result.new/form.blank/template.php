...
<div class="row mb-3">
	<div class="col">
		<div class="h2 fw-bold"><?= $arResult['arForm']['NAME'];?></div>
	</div>
</div>
			...
			case 'DEALERSHIP':
				...
				<div class="col-12 mb-3">
					<input 
						...
						/>
					<div class="form-group">
						<div class="form-dropcontainer position-relative <?= (($arResult['DEALERSHIPS_SELECTED_COUNT'])?'selected':'');?>" name="<?= $arItem['SID'];?>" data-name="<?= $arItem['TITLE'];?>" data-list="<?= $arItem['SID'];?>">
