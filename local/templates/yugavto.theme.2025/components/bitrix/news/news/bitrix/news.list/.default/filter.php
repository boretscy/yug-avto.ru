...
<div class="container">
	<div class="row">
		<div class="col">
			<div class="news-filter-tabs-content p-4 bg-yawhite d-flex flex-column justify-content-center align-items-start">
				...
				<?php } ?>
				<form class="row w-100" data-sid="NEWS_FILTER">
