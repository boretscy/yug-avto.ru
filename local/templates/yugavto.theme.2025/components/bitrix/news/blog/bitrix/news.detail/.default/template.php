...
<div class="bg-yalightbluegray pb-4" itemscope itemtype="http://schema.org/<?= $articleType;?>">
	...
	<div class="container">
		...
		<div class="row my-3 my-lg-5 blog-image">
			<div class="col">
		...
		<div class="row mb-4">
			<div class="col">
				<div class="blog-content bg-yawhite b-radius-yaradius-16 p-4" itemprop="articleBody">
		...
		<div class="bg-yawhite b-radius-yaradius-16 p-4">
			<div class="row">
				<?php foreach ($arResult['GALLERY'] as $k => $g) { ?>
				<div class="col-12 col-lg-4 mb-4 mb-lg-0">
					<img src="<?= $g;?>" class="w-100 b-radius-yaradius-16 overflow-hidden" alt="<?= htmlspecialchars(YApp::getCleanAltText($arResult['NAME'].' - галерея '.$k));?>" title="<?= htmlspecialchars(YApp::getCleanAltText($arResult['NAME'].' - галерея '.$k));?>" />
				</div>
				<?php } ?>
			</div>
		</div>
		...
		<div class="row my-4">
			<div class="col">
				<div class="blog-disclamer c-yadarkgray text-minus bg-yawhite b-radius-yaradius-16 p-4">
