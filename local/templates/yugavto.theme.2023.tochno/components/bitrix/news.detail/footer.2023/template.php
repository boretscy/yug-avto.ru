		...
		<div class="row py-3">
			<div class="col-lg-3 col-md-3 mb-3 mb-md-0 pt-2 text-center text-md-start">
				<a href="/" class="text-decoration-none">
					<img src="<?= SITE_TEMPLATE_PATH;?>/assets/images/svg/footer-logo.2023.svg">
				</a>
				<p class="mt-3">&copy; Юг-Авто <?= date('Y');?><br />Все права защищены</p>
			</div>
...
<div class="cookie bg-yablack c-yagray p-3 position-fixed w-100 bottom-0 text-minus-minus">
	<div class="container">
		<div class="row">
			<div class="col text-center"><?= $arResult['PROPERTIES']['COOKIE']['~VALUE']['TEXT'];?></div>
		</div>
	</div>
	<a href="#" role="close-cookie" class="text-decoration-none position-absolute">
