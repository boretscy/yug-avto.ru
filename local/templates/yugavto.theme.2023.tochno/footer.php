<?$APPLICATION->IncludeComponent("bitrix:news.detail", "footer.2023", Array(
	...
	false
        ...
        <?php include $_SERVER['DOCUMENT_ROOT'].SITE_TEMPLATE_PATH.'/include/cities.php'; ?>
        <?php include $_SERVER['DOCUMENT_ROOT'].SITE_TEMPLATE_PATH.'/assets/images/svg.php'; ?>
